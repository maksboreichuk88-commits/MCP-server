...
See [docs/STDIO_DEMO_TRANSCRIPT.md](docs/STDIO_DEMO_TRANSCRIPT.md) for the canonical transcript.
...
Use `PROXY_AUTH_TOKEN` for fail-closed auth, and `MCP_TARGET_COMMAND` plus `MCP_TARGET_ARGS_JSON` as the canonical downstream target input. See [docs/CLIENT_CONFIGS.md](docs/CLIENT_CONFIGS.md) for client examples.
...
The public install contract remains:
...
- demo transcript: [docs/STDIO_DEMO_TRANSCRIPT.md](docs/STDIO_DEMO_TRANSCRIPT.md)
